...
class ModelEvaluator:
    ...
    def plot_confusion_matrix(
        self, y_true: np.ndarray, y_pred: np.ndarray, model_name: str = "Model", figsize: Tuple[int, int] = (8, 6)
    ):
        """
    ...
    def plot_roc_curve(
        self, y_true: np.ndarray, y_pred_proba: np.ndarray, model_name: str = "Model", figsize: Tuple[int, int] = (8, 6)
    ):
        """
    ...
    def plot_models_comparison(
        self, df_comparison: pd.DataFrame, metric: str = "F1-Score", figsize: Tuple[int, int] = (12, 8)
    ):
        """
        ...
        sns.heatmap(
            df_comparison[metrics_cols].T, annot=True, fmt=".3f", xticklabels=df_comparison["Model"], cmap="RdYlBu_r"
        )
    ...
    def get_best_model(self, models_results: Dict[str, Dict], metric: str = "f1_score") -> Tuple[str, Dict]:
        """
